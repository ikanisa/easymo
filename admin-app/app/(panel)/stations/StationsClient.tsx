...
import { useStationsQuery, type StationsQueryParams } from '@/lib/queries/stations';

interface StationsClientProps {
  initialParams?: StationsQueryParams;
}

export function StationsClient({ initialParams = { limit: 200 } }: StationsClientProps) {
    ...
    <div className="admin-page">
      ...
      >
        {stationsQuery.isLoading ? (
          <LoadingState title="Loading stations" description="Fetching current station roster." />
        ) : stations.length ? (
