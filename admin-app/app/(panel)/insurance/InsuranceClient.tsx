...
import { useInsuranceQuotesQuery, type InsuranceQueryParams } from '@/lib/queries/insurance';

interface InsuranceClientProps {
  initialParams?: InsuranceQueryParams;
}

export function InsuranceClient({ initialParams = { limit: 100 } }: InsuranceClientProps) {
    ...
    <div className="admin-page">
      ...
      >
        {quotesQuery.isLoading ? (
          <LoadingState title="Loading insurance queue" description="Gathering latest quotes." />
        ) : quotes.length ? (
