...
export function StaffNumbersClient({ initialParams = { limit: 200 } }: StaffNumbersClientProps) {
    ...
    <div className="admin-page">
      ...
      >
        {staffNumbersQuery.isLoading ? (
          <LoadingState title="Loading staff numbers" description="Fetching latest receiving numbers." />
        ) : staffNumbers.length ? (
