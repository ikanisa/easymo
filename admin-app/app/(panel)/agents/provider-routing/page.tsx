...
export const metadata = createPanelPageMetadata("/agents/provider-routing");
  ...
  return (
    <ProtectedRoute requireAdmin>
      <div className="p-6 max-w-5xl mx-auto">
        <h1 className="text-2xl font-semibold mb-4">Provider Routing</h1>
        <div className="mb-3"><span className="text-xs border rounded px-2 py-0.5 bg-amber-100 text-amber-700">Admin only</span></div>
        <p className="text-sm text-gray-600 mb-6">Manage primary/fallback LLM providers and model settings for each agent.</p>
        <table className="w-full text-sm border">
          <thead>
            <tr className="bg-gray-50">
              ...
              <th className="text-left p-2 border">OpenAI</th>
              <th className="text-left p-2 border">Gemini</th>
