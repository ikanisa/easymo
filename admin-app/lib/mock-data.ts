...
export const mockMarketplaceSessions: MarketplaceAgentSession[] = [
  {
    id: "mock-session-pharmacy-1",
    agentType: "pharmacy",
    ...
    completedAt: null,
    requestData: {
      customer_msisdn: "+250780001234",
      items: [
        { name: "Amoxicillin 500mg", quantity: 2 },
        { name: "Paracetamol", quantity: 1 },
      ],
      location: { type: "Point", coordinates: [30.0588, -1.9536] },
    },
    customer: {
      msisdn: "+250780001234",
      location: { lat: -1.9536, lng: 30.0588 },
    },
    waThreadId: "mock-pharmacy-thread",
    quotes: [
      {
        id: "mock-quote-pharma-1",
        vendorId: "pharmacy-1",
        vendorType: "pharmacy",
        vendorName: "Kigali Pharma",
        offerData: { total_minor: 54000, eta_minutes: 20 },
        status: "pending",
        respondedAt: formatISO(subDays(now, 1)),
        rankingScore: 0.92,
        metadata: {},
      },
      {
        id: "mock-quote-pharma-2",
        vendorId: "pharmacy-2",
        vendorType: "pharmacy",
        vendorName: "Downtown Pharmacy",
        offerData: { total_minor: 51500, eta_minutes: 35 },
        status: "accepted",
        respondedAt: formatISO(subDays(now, 1)),
        rankingScore: 0.85,
        metadata: {},
    ...
    vendorResponses: [
      {
        id: "mock-response-pharma-1",
        quoteId: "mock-quote-pharma-2",
        vendorId: "pharmacy-2",
        vendorType: "pharmacy",
        channel: "whatsapp",
        requestMessage: "Need amoxicillin and paracetamol",
        responseMessage: "Available for 51,500 RWF, delivery in 30 minutes",
        parsed: { total_minor: 51500, currency: "RWF" },
        sentAt: formatISO(subDays(now, 1)),
        receivedAt: formatISO(subDays(now, 1)),
        metadata: {},
      },
    ],
    conversation: {
      threadId: "mock-thread-1",
      conversationId: "WA::mock-1",
      customerMsisdn: "+250780001234",
      lastMessageAt: formatISO(subDays(now, 1)),
      messages: [
        {
          id: "mock-message-1",
          direction: "user",
          content: "Hi, I need amoxicillin 500mg and paracetamol",
          createdAt: formatISO(subDays(now, 1)),
          metadata: {},
        },
        {
          id: "mock-message-2",
          direction: "assistant",
          content: "Sure! Sharing with nearby pharmacies now.",
          createdAt: formatISO(subDays(now, 1)),
          agentDisplayName: "EasyMO Pharmacy AI",
          metadata: {},
        },
      ],
    },
  ...
  {
    id: "mock-session-quinca-1",
    agentType: "quincaillerie",
    flowType: "nearby_quincailleries",
    status: "completed",
    startedAt: formatISO(subDays(now, 2)),
    completedAt: formatISO(subDays(now, 2)),
    requestData: {
      customer_msisdn: "+250788000555",
      items: [
        { name: "50mm PVC pipes", quantity: 30 },
        { name: "Industrial gloves", quantity: 10 },
      ],
      location: { type: "Point", coordinates: [30.0612, -1.9499] },
    },
    customer: {
      msisdn: "+250788000555",
      location: { lat: -1.9499, lng: 30.0612 },
    },
    waThreadId: "mock-quinca-thread",
    quotes: [
      {
        id: "mock-quote-quinca-1",
        vendorId: "hardware-1",
        vendorType: "quincaillerie",
        vendorName: "Nyabugogo Hardware",
        offerData: { total_minor: 185000, eta_minutes: 45 },
        status: "accepted",
        respondedAt: formatISO(subDays(now, 2)),
        rankingScore: 0.9,
        metadata: {},
      },
    ],
    vendorResponses: [
      {
        id: "mock-response-quinca-1",
        quoteId: "mock-quote-quinca-1",
        vendorId: "hardware-1",
        vendorType: "quincaillerie",
        channel: "whatsapp",
        requestMessage: "Need 30 PVC pipes and gloves",
        responseMessage: "Have everything in stock, total 185,000 RWF.",
        parsed: { total_minor: 185000 },
        sentAt: formatISO(subDays(now, 2)),
        receivedAt: formatISO(subDays(now, 2)),
        metadata: {},
      },
    ],
    conversation: {
      threadId: "mock-thread-2",
      conversationId: "WA::mock-2",
      customerMsisdn: "+250788000555",
      lastMessageAt: formatISO(subDays(now, 2)),
      messages: [
        {
          id: "mock-message-3",
          direction: "user",
          content: "Looking for PVC pipes",
          createdAt: formatISO(subDays(now, 2)),
          metadata: {},
        },
        {
          id: "mock-message-4",
          direction: "assistant",
          content: "Checking hardware suppliers nearby.",
          createdAt: formatISO(subDays(now, 2)),
          agentDisplayName: "EasyMO Hardware AI",
          metadata: {},
        },
      ],
    },
...
export const mockShops: Shop[] = [
  {
    ...
    description: "Neighbourhood shop covering groceries, OTC pharmacy, and fresh produce.",
    tags: ["grocery", "pharmacy", "fresh"],
    whatsappCatalogUrl: "https://wa.me/c/250788001111",
    phone: "+250788001111",
    ...
    rating: 4.6,
    totalReviews: 128,
    businessLocation: "Kigali Heights · Ground floor",
    coordinates: { lat: -1.9525, lng: 30.0601 },
    createdAt: formatISO(subDays(now, 12)),
    updatedAt: formatISO(subDays(now, 2)),
  },
  {
    id: "mock-shop-2",
    name: "Kacyiru Hardware Depot",
    description: "Trusted quincaillerie stocking plumbing, electrical, and site safety gear.",
    tags: ["hardware", "construction", "safety"],
    whatsappCatalogUrl: null,
    phone: "+250788004444",
    ...
    rating: 4.2,
    totalReviews: 64,
    businessLocation: "Kacyiru · KG 5 Ave",
    coordinates: { lat: -1.9367, lng: 30.0864 },
    createdAt: formatISO(subDays(now, 20)),
    updatedAt: formatISO(subDays(now, 5)),
  },
  {
    id: "mock-shop-3",
    name: "Nyamirambo Boutique",
    description: "Fashion and beauty shop with curated Kigali designer catalogues.",
    tags: ["fashion", "beauty", "tailor"],
    whatsappCatalogUrl: "https://wa.me/c/250789003333",
    phone: "+250789003333",
    ...
    rating: 4.9,
    totalReviews: 210,
    businessLocation: "Nyamirambo · KN 181 St",
    coordinates: { lat: -1.9678, lng: 30.0567 },
