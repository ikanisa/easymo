...
import { listMenuVersions, type PaginatedResult, listOcrJobs } from '@/lib/data-provider';
...
const menuKey = (params: MenuQueryParams) => ['menu-versions', params] satisfies QueryKey;
const ocrKey = (params: OcrJobQueryParams) => ['ocr-jobs', params] satisfies QueryKey;
...
export function useMenuVersionsQuery(
  params: MenuQueryParams = { limit: 100 },
  options?: UseQueryOptions<PaginatedResult<MenuVersion>, unknown, PaginatedResult<MenuVersion>>
) {
  return useQuery({
...
export function useOcrJobsQuery(
  params: OcrJobQueryParams = { limit: 50 },
  options?: UseQueryOptions<PaginatedResult<OcrJob>, unknown, PaginatedResult<OcrJob>>
) {
  return useQuery({
