...
const storageKey = (params: StorageQueryParams) => ['storage-objects', params] satisfies QueryKey;
...
export function useStorageObjectsQuery(
  params: StorageQueryParams = { limit: 200 },
  options?: UseQueryOptions<PaginatedResult<StorageObject>, unknown, PaginatedResult<StorageObject>>
) {
  return useQuery({
