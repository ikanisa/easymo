...
const notificationsKey = (params: NotificationsQueryParams) => ['notifications', params] satisfies QueryKey;
...
export function useNotificationsQuery(
  params: NotificationsQueryParams = { limit: 200 },
  options?: UseQueryOptions<PaginatedResult<NotificationOutbox>, unknown, PaginatedResult<NotificationOutbox>>
) {
  return useQuery({
...
export const notificationsQueryKeys = {
  list: (params: NotificationsQueryParams = { limit: 200 }) => notificationsKey(params)
} as const;
