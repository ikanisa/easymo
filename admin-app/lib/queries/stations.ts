...
const stationsKey = (params: StationsQueryParams) => ['stations', params] satisfies QueryKey;
...
export function useStationsQuery(
  params: StationsQueryParams = { limit: 200 },
  options?: UseQueryOptions<PaginatedResult<Station>, unknown, PaginatedResult<Station>>
) {
  return useQuery({
