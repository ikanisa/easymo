...
const insuranceKey = (params: InsuranceQueryParams) => ['insurance-quotes', params] satisfies QueryKey;
...
export function useInsuranceQuotesQuery(
  params: InsuranceQueryParams = { limit: 100 },
  options?: UseQueryOptions<PaginatedResult<InsuranceQuote>, unknown, PaginatedResult<InsuranceQuote>>
) {
  return useQuery({
