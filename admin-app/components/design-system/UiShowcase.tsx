    ...
    <div className="space-y-10">
      ...
      <section className="grid gap-6 lg:grid-cols-[320px_1fr]">
        <div className="space-y-4 rounded-3xl border border-[color:var(--color-border)]/60 bg-[color:var(--color-surface)]/80 p-5 shadow-[var(--elevation-low)]">
          ...
          <UiInput placeholder="Lookup vendor by phone" startAdornment="🔍" />
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogTrigger asChild>
              <UiButton className="w-full">Create escalation</UiButton>
            </DialogTrigger>
            <DialogContent>
              <DialogTitle>Escalate vendor incident</DialogTitle>
              <DialogDescription>
