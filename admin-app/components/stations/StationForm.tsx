    ...
    <form className={styles.form} onSubmit={handleSubmit}>
      <div className={styles.row}>
        ...
        <label>
          ...
          <input required value={engencode} onChange={(event) => setEngencode(event.target.value)} />
        </label>
        <label>
          <span>Owner contact</span>
          <input value={ownerContact} onChange={(event) => setOwnerContact(event.target.value)} />
        </label>
        <label>
          <span>Status</span>
