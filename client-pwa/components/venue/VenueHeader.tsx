...
export function VenueHeader({ venue, tableNumber }: VenueHeaderProps) {
  ...
  const isOpen = checkIfOpen(venue.operating_hours);
    ...
    <>
      ...
      <div className="relative h-72 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-0 inset-x-0 p-4 flex justify-between items-start pt-safe"
        >
          <button
            onClick={handleBack}
...
function checkIfOpen(operatingHours: Record<string, { open: string; close: string }> | undefined): boolean {
