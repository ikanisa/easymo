...
## Prerequisites
- Google Cloud Project (gen-lang-client-0738932886)
...
gcloud run deploy easymo-webhook --image gcr.io/gen-lang-client-0738932886/easymo-webhook \
...
gcloud run deploy easymo-admin-api --image gcr.io/gen-lang-client-0738932886/easymo-admin-api \
  --region us-central1 --allow-unauthenticated --set-env-vars=GCP_PROJECT_ID=gen-lang-client-0738932886
```
