...
**Date:** 2025-12-09 **Task:** Waiter AI Agent Discovery Flow + Buy & Sell AI Agent Enhancement
...
- Seed file expects: `ai_agents`, `ai_agent_personas`, `ai_agent_system_instructions`,
  `ai_agent_tools`
