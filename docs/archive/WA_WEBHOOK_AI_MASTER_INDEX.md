...
An **additive-only** integration that connects WhatsApp messages to AI agents powered by OpenAI,
enabling natural language conversations while respecting existing functionality.
