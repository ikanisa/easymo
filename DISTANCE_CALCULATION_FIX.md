...
The distance computation between users and businesses was using an inaccurate Haversine formula approximation that assumes Earth is a perfect sphere with radius 6371 km. This causes distance calculation errors that can be significant, especially over longer distances.
