...
- [ ] Created GCP project (easymo-478117) or have access
- [ ] Billing enabled on the project
- [ ] `gcloud` CLI installed on your machine
- [ ] Authenticated: `gcloud auth login`
- [ ] Project set: `gcloud config set project easymo-478117`
...
gcloud run deploy easymo-admin-api \
  --image gcr.io/easymo-478117/easymo-admin-api \
  --region us-central1 \
  --allow-unauthenticated \
...
gcloud builds submit --tag gcr.io/easymo-478117/indexer-service

gcloud run deploy indexer-service \
  --image gcr.io/easymo-478117/indexer-service \
  --region us-central1 \
...
gcloud builds submit --tag gcr.io/easymo-478117/easymo-frontend .

gcloud run deploy easymo-frontend \
  --image gcr.io/easymo-478117/easymo-frontend \
  --region us-central1 \
  --allow-unauthenticated
```
...
https://console.firebase.google.com/project/easymo-478117/firestore
```
...
gcloud bigquery query --use_legacy_sql=false \
  'SELECT * FROM `easymo-478117.easymo_analytics.cold_call_logs` LIMIT 10'
```
