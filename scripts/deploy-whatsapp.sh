...
echo "-- Deploying Edge Functions (wa-webhook, insurance-ocr)..."
supabase functions deploy wa-webhook insurance-ocr
...
echo "  3) Tail logs if needed: supabase functions logs wa-webhook --tail"
