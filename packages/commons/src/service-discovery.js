...
export class ServiceRegistry {
    ...
    register(endpoint) {
        ...
        const breaker = new CircuitBreaker(async (url, init) => {
     ...
     */
    async request(serviceName, path, init) {
    ...
    startHealthChecks() {
        ...
        this.healthCheckInterval = setInterval(async () => {
            ...
            await Promise.allSettled(endpoints.map((endpoint) => this.checkHealth(endpoint)));
     ...
     */
    setHealthStatus(serviceName, url, healthy) {
