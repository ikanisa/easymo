...
export class MetricsRegistry {
     ...
     */
    recordHTTPRequest(method, route, statusCode, durationSeconds, requestSize, responseSize) {
     ...
     */
    recordBusinessOperation(operation, durationSeconds, status) {
 ...
 */
export function metricsMiddleware(metricsRegistry) {
    return (req, res, next) => {
        const start = Date.now();
        // Get request size
        ...
        res.end = function (...args) {
            ...
            // Record metrics
            metricsRegistry.recordHTTPRequest(req.method, route, res.statusCode, durationSeconds, requestSize, responseSize);
 ...
 */
export function metricsHandler(metricsRegistry) {
 ...
 */
export function createMetricsRegistry(serviceName, options) {
