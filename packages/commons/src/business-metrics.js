...
export class BusinessMetrics {
    ...
    // Ride Metrics
    rideRequestsTotal;
    rideRequestsAccepted;
    rideRequestsRejected;
    rideDuration;
    activeRides;
    // Payment Metrics
    ...
    trackWhatsAppMessage(messageType, status, errorCode) {
    ...
    trackDatabaseQuery(queryType, table, durationSeconds, error) {
    ...
    setUserSessions(userType, count) {
        this.userSessions.set({ user_type: userType }, count);
    }
    setAgentsOnline(agentType, count) {
        this.agentOnlineCount.set({ agent_type: agentType }, count);
    }
    trackAgentResponse(agentType, durationSeconds) {
 ...
 */
export function createBusinessMetrics(metricsRegistry) {
