...
export const BK_PROVIDER: TariffProvider = {
  name: "BK Insurance",
  seatLoading: {
  ...
  otf: {
    privateUse: {
      ...
      PICKUP_SMALL_LORRY: otf(0.0258, 0.0038, 0.0026),
      MINIBUS_VAN: otf(0.0256, 0.0034, 0.003),
      BUS: otf(0.026, 0.0035, 0.003),
    },
    commercialPassenger: {
  ...
  mandatoryExcess: {
    byVehicleType: {
      MOTORCYCLE: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 100_000 },
      CAR: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 150_000 },
      JEEP_SUV: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 200_000 },
      PICKUP_SMALL_LORRY: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 200_000 },
      TRUCK_LORRY_5T_PLUS: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 850_000 },
      TRAILER: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 850_000 },
      MINIBUS_VAN: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 500_000 },
      BUS: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 500_000 },
      PSV: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 500_000 },
      MINIBUSES_BUSES_SCHOOL: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 500_000 },
      TRUCKS_LORRIES_TRAILERS_TRACTORS: { md_percent_of_claim: 0.05, theft_fire_percent_total_loss: 0.025, minimum_rwf: 850_000 },
    },
  },
  notes: [
    "Driving school uses commercial transport of goods OTF rates.",
    "Flammable goods +20% to TP goods base.",
    "Fees 2,500 per guarantee local; COMESA fee 10,000 per vehicle; cumulative.",
  ],
};
