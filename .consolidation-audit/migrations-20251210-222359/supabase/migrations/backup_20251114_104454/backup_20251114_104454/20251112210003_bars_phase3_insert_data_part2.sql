-- =====================================================
-- PHASE 3: Insert bars data (Part 2 - Records 51-100)
-- Migration: 20251112210003_bars_phase3_insert_data_part2.sql
-- Description: Insert next 50 bars records
-- =====================================================
...
VALUES
  ...
  ('Kiruhura Disque Orange', 'Kigali, Rwanda', 'Rwanda', 'Kigali', 'RWF', 'kiruhura-disque-orange'),
  ('Heroes Lounge', 'KG 232 St, Kigali, Rwanda', 'Rwanda', 'Kigali', 'RWF', 'heroes-lounge'),
  ('Maestro Kitchen', 'KK 21 Ave, Kigali, Rwanda', 'Rwanda', 'Kigali', 'RWF', 'maestro-kitchen'),
  ('Aqualuna Lido', 'Tower Road, Sliema, Malta', 'Malta', 'Sliema', 'EUR', 'aqualuna-lido')
