-- =====================================================
-- PHASE 2: Insert bars data (first batch)
-- =====================================================
-- Purpose: Insert bar records with proper conflict handling
-- Safe to run: Uses ON CONFLICT to prevent duplicates

BEGIN;

-- Insert bars data with ON CONFLICT DO NOTHING to prevent duplicates
