-- Phase 2: rewrite matching RPCs as SECURITY INVOKER and remove unused helpers
BEGIN;

-- Ensure legacy RPCs are gone (no-op if already dropped)
...
-- Recreate v2 matching RPCs with SECURITY INVOKER semantics
