...
## Issue
The Supabase CLI `db push` command hangs when connecting to the remote database.
This appears to be a network/connection issue with the Postgres connection.
...
Local migration count: 277 files
Last applied remote: 20260425110000
...
### Can Skip (Duplicates):
- Multiple bars_* migrations with same timestamp
...
⚠️  Database Migrations - PENDING (CLI issue)
