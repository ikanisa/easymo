#!/bin/bash
# Step 2: Apply Database Migration Only
...
psql "$DATABASE_URL" -f supabase/migrations/20251204130000_insurance_core_schema.sql
...
if [ $? -eq 0 ]; then
    ...
    psql "$DATABASE_URL" -c "SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name LIKE 'insurance_%' ORDER BY table_name;"
    ...
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "Next: Run ./step3-commit-and-deploy.sh"
else
    echo ""
