-- =====================================================
-- PHASE 1: CREATE BARS TABLE WITH PROPER SCHEMA
-- =====================================================
-- Migration: Create bars table structure
-- Date: 2025-11-12
-- Description: Create bars table with all required columns including geography support
...
COMMENT ON TABLE public.bars IS 'Stores bar and restaurant information with geographic data for location-based queries';
