...
-- Date: 2025-11-12
-- Description: Phase 1 - Create the bars table structure
...
COMMENT ON TABLE public.bars IS 'Bars and restaurants directory with location and contact information';
