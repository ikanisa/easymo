-- =====================================================
-- BARS TABLE MIGRATION - PHASE 1 (Records 1-100)
-- Generated: 2025-11-12 22:00 UTC
-- =====================================================

BEGIN;

-- Phase 1: Insert first 100 bars
...
VALUES
  ...
  ('Okurama Asian Fusion 2', 'St. George''s Bay, St. Julian''s, Malta', 'Malta', 'St. Julian''s', 'EUR', 'okurama-asian-fusion-2'),
  ...
  ('The Londoner British Pub Sliema 2', 'Triq ix-Xatt, Sliema, Malta', 'Malta', 'Sliema', 'EUR', 'the-londoner-british-pub-sliema-2'),
...
DO $$
BEGIN
  RAISE NOTICE '✅ Phase 1 completed: 100 bars inserted';
END $$;
