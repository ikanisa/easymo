...
export const SUPABASE_SERVICE_ROLE_KEY = mustGetOne("SUPABASE_SERVICE_ROLE_KEY");
export const SUPABASE_ANON_KEY = getEnv("SUPABASE_ANON_KEY") ?? "";
export const WA_PHONE_ID = mustGetOne("WA_PHONE_ID", "WHATSAPP_PHONE_NUMBER_ID");
...
export const WA_VERIFY_TOKEN = mustGetOne("WA_VERIFY_TOKEN", "WHATSAPP_VERIFY_TOKEN");
export const OPENAI_API_KEY = getEnv("OPENAI_API_KEY") ?? "";
export const WA_BOT_NUMBER_E164 = getEnv("WA_BOT_NUMBER_E164", "WHATSAPP_PHONE_NUMBER_E164") ?? "";
export const QR_SALT = getEnv("QR_SALT") ?? "";
export const MENU_MEDIA_BUCKET = getEnv("MENU_MEDIA_BUCKET") ?? "menu-source-files";
export const INSURANCE_MEDIA_BUCKET = getEnv("INSURANCE_MEDIA_BUCKET") ?? "insurance-docs";
