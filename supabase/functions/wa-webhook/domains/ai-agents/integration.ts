...
export interface AgentRequest {
  userId: string;
  agentType:
    | "nearby_drivers" // Keeping for now as it might be used by legacy code, but handler will be removed
    | "pharmacy" // Keeping for now
    | "property_rental"
    | "schedule_trip" // Keeping for now
    | "shops" // Keeping for now
    | "quincaillerie" // Keeping for now
    | "notary";
  flowType: string;
  requestData: any;
