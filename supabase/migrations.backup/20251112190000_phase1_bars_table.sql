...
-- Phase 1: Bars Table Creation and Data
...
CREATE INDEX IF NOT EXISTS idx_bars_currency ON public.bars(currency);
...
COMMENT ON TABLE public.bars IS 'Stores bar and restaurant information for the marketplace';
