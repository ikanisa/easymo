...
CREATE INDEX IF NOT EXISTS idx_wa_events_wa_id_created_at 
...
CREATE INDEX IF NOT EXISTS idx_insurance_leads_whatsapp_status_created 
...
CREATE INDEX IF NOT EXISTS idx_wa_events_wa_id_event_type_created 
...
CREATE INDEX IF NOT EXISTS idx_insurance_leads_status_created 
