-- Fix driver_profiles table reference in matching functions
-- The driver_profiles table doesn't exist, use rides_trips.number_plate instead

BEGIN;

-- Drop and recreate match_drivers_for_trip_v2 without driver_profiles join
