-- ============================================================================
-- Fix ensure_whatsapp_user Function - Remove locale column reference
-- Migration: 20251216120000_fix_ensure_whatsapp_user_locale.sql
-- Date: 2025-12-16
--
-- PURPOSE: 
-- Fix the ensure_whatsapp_user function to use only 'language' column
-- The 'locale' column doesn't exist in the profiles table
-- ============================================================================

BEGIN;

-- Recreate the function without locale column references
