...
DROP POLICY IF EXISTS "Service role can manage routing config" ON public.webhook_routing_config;
...
DROP POLICY IF EXISTS "Service role can manage routing logs" ON public.webhook_routing_logs;
